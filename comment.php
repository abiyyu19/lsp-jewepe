          ...
          <div class="table-responsive mt-4">
            <table class="table table-striped table-dark">
              ...
              <tbody>
                ...
                $query = "SELECT * FROM komentar INNER JOIN artikel ON komentar.id_artikel = artikel.id_artikel;";
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <form method="post" action="comment.php?id_komentar=<?php echo $id_komentar; ?>">
