...
if (isset($_POST['submit'])) {
  ...
  $query = "INSERT INTO laporan (laporan, created_at, id_admin) VALUES ('$laporan', '$created_at', '$id_admin')";

  // Eksekusi query
  if (mysqli_query($conn, $query)) {
    echo "Laporan berhasil ditambahkan.";
    echo '<script>alert("Laporan berhasil ditambahkan.")</script>';
      ...
      <div class="col-auto col-md-3 col-xl-2 px-sm-5 bg-dark">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-2 pt-2 text-white min-vh-100">
          ...
          <ul class="nav nav-pills flex-column mb-sm-auto align-items-center align-items-sm-start border-top" id="menu">
            ...
            <li class="nav-item">
              <a href="/report.php" class="nav-link align-middle px-0 text-white">
      ...
      <div class="col py-3 px-4">
        ...
        <main class="row overflow-auto">
          <div class="container mt-4">
            <h1 class="text-center">Tambah Laporan</h1>
            <form action="add_report.php" method="POST" enctype="multipart/form-data">
              <div class="mb-3">
                <div class="mb-3">
                  <label for="laporan" class="form-label font-weight-bold h4">Laporan</label>
                  <textarea class="form-control form-control-lg border rounded border-dark" id="laporan" name="laporan" required></textarea>
                </div>
